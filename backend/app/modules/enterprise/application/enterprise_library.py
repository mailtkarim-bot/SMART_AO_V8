...
from app.modules.enterprise.application.ports import EnterpriseLibraryReader
...
class EnterpriseLibraryService:
    ...
    def __init__(
        ...
        *,
        ...
        reader: EnterpriseLibraryReader | None = None,
    ) -> None:
    ...
    def read_company(
        ...
        *,
        ...
        if self._reader is None:
            raise RuntimeError("ENTERPRISE_LIBRARY_READER_NOT_CONFIGURED")
        projection = self._reader.read_company(tenant_id=actor.tenant_id)
