...
def _measure(engine: sa.Engine) -> dict[str, float | int]:
    ...
    return module.measure(engine)


@pytest.mark.db
def test_assignment_change_journal_performance_budget() -> None:
