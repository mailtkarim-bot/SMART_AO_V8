...
- [x] **OPPORTUNITY-WATCH-PROFILE-01 / incrément domaine-application** — contrat du profil de veille patronal, value object pur, catalogues fermés, normalisation déterministe, hash canonique et capabilities patronales publiés localement sur la branche courante. La persistence versionnée, la lecture HTTP et l’ingestion de sources restent les incréments suivants.
